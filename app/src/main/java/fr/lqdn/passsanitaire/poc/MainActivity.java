...
public class MainActivity extends AppCompatActivity
    ...
    private void startCamera() {
        ...
        integrator.initiateScan(Collections.singleton("DATA_MATRIX"));
    }
    ...
    public void processScanResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (result != null) {
            String cev = result.getContents();
            if (cev != null) {
                parseCev(result.getContents());
            }
        } else {
    ...
    private void parseCev(String cev) {
        ...
        if (matcher.find()) {
            ...
            String creationDate = calculateDateFromHexa(matcher.group(3));
            ...
            switch(documentType) {
                case CEV_TYPE_VIROLOGICAL:
                    parseCevVirological(cev, ca, certId, creationDate, signatureDate, documentType, perimeterId, country);
                    break;
                case CEV_TYPE_VACCINATION:
                    parseCevVaccination(cev, ca, certId, creationDate, signatureDate, documentType, perimeterId, country);
                    break;
                default:
    ...
    private void parseCevVaccination(String cev, String ca, String certId,
                                 String creationDate, String signatureDate,
                                 String documentType, String perimeterId,
                                 String country)
    {
        Pattern pattern;
        Matcher matcher;
        ...
        if (matcher.find()) {
            ...
            String prophylacticAgent = matcher.group(5);
            ...
            saveVaccination(ca, certId, creationDate, signatureDate, documentType,
                            perimeterId, country, firstNames, lastName, birthDate,
                            disease, prophylacticAgent, vaccineName, vaccineManufacter,
                            lastVaccinationStatusRank, requiredVaccinationStatus, lastVaccinationStatusDate,
                            vaccinationStatus);
        } else {
    ...
    private void parseCevVirological(String cev, String ca, String certId,
                             String creationDate, String signatureDate,
                             String documentType, String perimeterId,
                             String country)
    {
        ...
        if (matcher.find()) {
            ...
            saveVirological(ca, certId, creationDate, signatureDate, documentType,
                            perimeterId, country, firstNames, lastName, birthDate,
                            gender, analysisCode, resultCode, dayAndHour);
        } else {
    ...
    private void saveVaccination(String ca, String certId, String creationDate, String signatureDate,
                                 String documentType, String perimeterId, String country, String firstNames,
                                 String lastName, String birthDate, String disease, String prophylacticAgent,
                                 String vaccineName, String vaccineManufacter, String lastVaccineStatusRank,
                                 String requiredVaccineStatus, String lastVaccineStatusDate, String vaccineStatus)
    {
        String fileContents = signatureDate + CSV_SEPARATOR +
                              ...
                              prophylacticAgent + CSV_SEPARATOR +
    ...
    private void saveVirological(String ca, String certId, String creationDate, String signatureDate,
                         String documentType, String perimeterId, String country, String firstNames,
                         String lastName, String birthDate, String gender, String analysisCode,
                         String resultCode, String dayAndHour)
    {
        String fileContents = signatureDate + CSV_SEPARATOR +
                              firstNames + CSV_SEPARATOR +
                              lastName + CSV_SEPARATOR +
